...
public class HomeController {
    ...
    @GetMapping("/")
    public String home(Model model,@RequestParam(required = false,name="sort_by",defaultValue = "createAt") String sort_by,
    ...
    @RequestParam(required = false,name="page",defaultValue = "1") String page){
        ...
        model.addAttribute("posts", posts_on_page.getContent());
